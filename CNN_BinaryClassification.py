...
class CNN_BinaryClassification(nn.Module):
    def __init__(self):
        ...
        self.convlutionalLayer1 = nn.Conv2d(in_channels=3, out_channels=32, kernel_size=3, bias=False,
                                            dtype=torch.float64)
        self.maxPooling1 = nn.MaxPool2d(kernel_size=2, stride=2)

        self.convlutionalLayer2 = nn.Conv2d(in_channels=32, out_channels=32, kernel_size=3, bias=False,
                                            dtype=torch.float64)
