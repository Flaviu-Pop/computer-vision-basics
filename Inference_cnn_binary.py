...
img_1_maia = torchvision.io.read_image(
    "C:\Learning\Computer Science\Machine Learning\\02 Databases Used\CV Datasets\Binary Classification CV Datasets\Cat Vs Dog\single_prediction\maia2023.jpg").type(
    torch.FloatTensor).unsqueeze(0)
img_2_dog = torchvision.io.read_image(
    "C:\Learning\Computer Science\Machine Learning\\02 Databases Used\CV Datasets\Binary Classification CV Datasets\Cat Vs Dog\single_prediction\cat_or_dog_1.jpg").type(
    torch.FloatTensor).unsqueeze(0)
img_3_cat = torchvision.io.read_image(
    "C:\Learning\Computer Science\Machine Learning\\02 Databases Used\CV Datasets\Binary Classification CV Datasets\Cat Vs Dog\single_prediction\cat_or_dog_2.jpg").type(
    torch.FloatTensor).unsqueeze(0)
