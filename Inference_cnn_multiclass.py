...
img_1_maia = torchvision.io.read_image(
    "C:\Learning\Computer Science\Machine Learning\\02 Databases Used\CV Datasets\My Images\ForDeplymentCIFAR10\maia2023.jpg").type(
    torch.FloatTensor).unsqueeze(0)
img_2_bird = torchvision.io.read_image(
    "C:\Learning\Computer Science\Machine Learning\\02 Databases Used\CV Datasets\My Images\ForDeplymentCIFAR10\IMG_20190720_100620.jpg").type(
    torch.FloatTensor).unsqueeze(0)
img_3_bird = torchvision.io.read_image(
    "C:\Learning\Computer Science\Machine Learning\\02 Databases Used\CV Datasets\My Images\ForDeplymentCIFAR10\IMG_20190720_100643.jpg").type(
    torch.FloatTensor).unsqueeze(0)
img_4_cat = torchvision.io.read_image(
    "C:\Learning\Computer Science\Machine Learning\\02 Databases Used\CV Datasets\My Images\ForDeplymentCIFAR10\IMG_20190911_133815.jpg").type(
    torch.FloatTensor).unsqueeze(0)
img_5_car = torchvision.io.read_image(
    "C:\Learning\Computer Science\Machine Learning\\02 Databases Used\CV Datasets\My Images\ForDeplymentCIFAR10\IMG_20220304_134719.jpg").type(
    torch.FloatTensor).unsqueeze(0)
